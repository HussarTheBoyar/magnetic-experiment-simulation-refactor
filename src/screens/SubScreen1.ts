...
sidebar.addImage('Nam châm', '/assets/bar-magnet-image.png');
sidebar.addImage('Nam châm chữ U', '/assets/u-magnet.png');
sidebar.addImage('Nam châm có sẵn móc treo', '/assets/bar-magnet.png');
sidebar.addImage('Điểm treo', '/assets/pivot.png');
